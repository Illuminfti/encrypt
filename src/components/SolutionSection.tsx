          ...
          {solution.cards.map((card, i) => {
            ...
            return (
              <motion.div
                ...
                className="relative rounded-3xl bg-abyss/40 border border-white/[0.06] p-8 lg:p-10 hover:border-ultraviolet/20 transition-colors duration-300"
              >
                {/* Mini SVG */}
                <div className="absolute top-6 right-6 text-ultraviolet">
                  <Motif />
                </div>

                <p className="text-xs font-display text-ultraviolet/60 mb-4">
                  {card.step}
                </p>
